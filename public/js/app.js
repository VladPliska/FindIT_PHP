...
// require('jquery')
window.popup = __webpack_require__(/*! sweetalert2/dist/sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.js");
...
$(document).on('click', '.regCompany', function (e) {
  var data = $('#city')[0].value;
  var pass = $('input[name=password]').val();
  var reppass = $('input[name=reppass]').val();
  var email = $('input[name=email]').val();
  var img = $('#imgChange')[0].files;
  console.log(img);
...
$(document).on('change', '#imgChange', function () {
  var a = document.getElementById('imgChange').files[0];
...
$('#create-advert').on('submit', function (e) {
  var tech = $(this).find('.technoI.active');
  var city = $(this).find('select');
  ...
  if (tech.length == 0) {
    e.preventDefault();
    $(this).find('.typeTitle').addClass('empty'); // tech.addClass('empty');
  }
});
